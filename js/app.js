(() => {
    ...
    (() => {
        ...
        document.addEventListener("DOMContentLoaded", (event => {
            ...
            document.querySelectorAll(".managers-files-item").forEach((item => item.addEventListener("sendMessage", (event => {
                console.log(event);
            }))));
            document.querySelectorAll(".managers-files-item").forEach((item => item.addEventListener("createTippy", (event => {
